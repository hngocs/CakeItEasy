package com.hngocs.cakeiteasy.screens.adapters;


import android.content.Context;
import android.graphics.Paint; // Import thư viện Paint
...
import com.hngocs.cakeiteasy.R; // Thay bằng package của bạn
